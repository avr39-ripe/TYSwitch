...
void onAJAXSetState(HttpRequest &request, HttpResponse &response)
{
//	if (request.getBody() == NULL)
//	{
...
//		root.prettyPrintTo(Serial); //Uncomment it for debuging
//
//		if (root["switch_state"].success()) // Settings
//		{
//			digitalWrite(4, root["switch_state"] ? 1 : 0);
//		}
//	}
	thermoHead.httpSetState(request);
}
...
void startWebServer()
{
	...
	server.addPath("/set_state", onAJAXSetState);
